...
% % imwrite(pencil_result_color,[filename,'_resultColorJS.jpg']);
% % imwrite(pencil_resultEhance,[filename,'_resultGrayJS.jpg']);
% % imwrite(Sketch_IlluminationEnhance_Reflectance,[filename,'_sketchA.jpg']);
