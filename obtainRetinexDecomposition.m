function [Illumination_layer, Relecance_layer] = obtainRetinexDecomposition(im)
...
[i,r] = L2L0(s,i0,0.001,0.02,0.5,0);   % L2L0(s,i0,lamda,a,b,flag); flag = 1 normal processing; flag = 0 fast processing
